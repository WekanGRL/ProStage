 ...
 */
final class Version20220105141212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprises_id INT NOT NULL, titre VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, email_contact VARCHAR(30) DEFAULT NULL, INDEX IDX_C27C9369A70A18EC (entreprises_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
